package simpleDelegator2.core.core;
...
import simpleDelegator2.api.core.ApplicationException;
import simpleDelegator2.api.core.ApplicationLauncher;
import simpleDelegator2.application.Application;
import simpleDelegator2.application.RootController;
...
public abstract class AbstractApplicationLauncher extends
	...
	protected Application doInBackground() throws Exception {
		...
		if(null != application) {
			this.debugJustInCase("Init: application is not_null");
		}else {
			this.debugJustInCase("Init: application is_null");
		}
		if(null != viewaProperties) {
			this.debugJustInCase("Init: viewaProperties is not_null");
		}else {
			this.debugJustInCase("Init: viewaProperties is_null");
		}
	...
	protected void done()  {
		try {
		 ...
		 /* --------------------------------- INIT UI ---- (3) --------------------------------- */
			...
			logger.info("check_post_5");
			notifyInit();
			logger.info("check_post_6");
